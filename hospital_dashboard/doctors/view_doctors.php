...
$query = "SELECT d.*, dp.name AS department_name 
          ...
          WHERE d.doctor_id LIKE '%$searchQuery%' 
             ...
             OR d.contact_info LIKE '%$searchQuery%' 
             OR d.email LIKE '%$searchQuery%' 
             OR d.address LIKE '%$searchQuery%' 
...
<div class="container-fluid mt-4">
    ...
    <form method="get" class="mb-3">
        <div class="input-group">
            <input type="text" name="search" class="form-control" placeholder="Search by Doctor ID, Name, Specialty, etc." value="<?php echo htmlspecialchars($searchQuery); ?>">
